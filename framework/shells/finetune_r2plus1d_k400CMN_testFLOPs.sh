cd few-shot-video-classification/ && CUDA_VISIBLE_DEVICES=1 python finetune_metatrain.py --video_path /home/linhanxi/home_data/k400_CMNsplit/ \
...
--ft_begin_index 0 \
--result_path /media/hdd/sda1/linhanxi/exp/few-shot-vid-cls/finetune_kinetics_testFLOPs