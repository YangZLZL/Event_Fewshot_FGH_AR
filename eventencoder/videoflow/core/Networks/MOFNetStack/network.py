...
class MOFNet(nn.Module):
    ...
    def forward(self, images, eventfeature, data={}, flow_init=None):
        ...
        #print("forward_corr_fn", forward_corr_fn)
        ...
        for itr in range(self.cfg.decoder_depth):
            ...
            #print("forward_corr", forward_corr.shape) #forward_corr torch.Size([6, 324, 28, 28])
            ...
            #print("beforeflowhead:",beforeflowhead.shape)
            return beforeflowhead
